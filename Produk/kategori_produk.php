...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <!-- produk -->
            <h2 class="my-3 mt-5"><b><?php echo $kategori["nama_kategori"] ?></b></h2>
            <div class=" d-flex flex-wrap " id="load_produk">
                <?php foreach($produk as $row) { ?>
                <div class=" box flex-row bg-highlight mb-4 px-4">
                    <div class="item  " style="height: 450px;">
                        <a style="text-decoration: none;"
                            href="detail_produk.php?id_produk=<?php echo $row['id_produk'] ?>" data-bs-toggle="tooltip"
                            data-bs-placement="top" title="Klik untuk melihat detail produk">
        ...
        <div class="container flex-lg-wrap d-flex ">
            <div class="col-3 flex-row mx-3">
                ...
                <p class="text-center pt-3">
                    ...
                    corrupti
                    tenetur itaque, cupiditate quas reprehenderit alias asperiores perferendis neque mollitia sapiente
                    omnis
                    excepturi accusamus? Ab, ducimus!
                </p>
            </div>
            <div class="col-3 flex-row mx-3">
                <div class="text-center">
