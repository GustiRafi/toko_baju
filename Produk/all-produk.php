...
$produk = query("SELECT * FROM produk WHERE status_produk = 1  ORDER BY id_produk DESC LIMIT  30");
...
<body>
    ...
    <div class="container mt-5">
        ...
        <h2 class=" my-3 pt-5"><b>Produk</b></h2>
        <div class=" d-flex flex-wrap pb-3" id="load_produk">
                    ...
                    <div class="card-body">
                        ...
                        <a href="../Keranjang/jumlah_ukuran.php?id_produk=<?php echo $row['id_produk']  ?>"
                            ...
                            title="Klik untuk menambahkan produk ke keranjang"><button type="submit"
                                class="rounded-6 btn btn-outline-light w-100" style="border-radius: 15px;"><i
    ...
    <div id="carouselExampleIndicators" class="carousel slide mb-3" data-bs-ride="carousel">
        <button class="carousel-control-prev pb-3" type="button" id="sebelum"
            data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
            <span class="carousel-control-prev-icon  bg-dark me-3" aria-hidden="true"></span>
            <span class="visually text-dark">Previous</span>
        </button>
        <button class="carousel-control-next pb-3" type="button" id="selanjut"
            data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
            <span class="visually text-dark">Next</span>
            <span class="carousel-control-next-icon bg-dark mx-3" aria-hidden="true"></span>
        </button>
    </div>
    </div>
    ...
    $(document).ready(function() {
        ...
        $('#keyword').on('keyup', function() {
            $('#load_produk').load('../ajax/load_produk2.php?keyword=' + $('#keyword').val());
        });

        $('#sebelum').hide();

        //event ketika next di klik
        $('#selanjut').on('click', function() {
            $('#sebelum').show();
        });
    });
    </script>
        ...
        <div class="container flex-lg-wrap d-flex ">
            <div class="col-3 flex-row mx-3">
                ...
                <p class="text-center pt-3">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, hic voluptatibus cumque, distinctio
                    corrupti!
                </p>
            </div>
            <div class="col-3 flex-row mx-3">
