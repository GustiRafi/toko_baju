...
<head>
    ...
    <title> TAMBAH Kategori | Fassen </title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="" class="mt-3 w-auto" method="post" enctype="multipart/form-data">
                        <input type="text" class="form-control" name="kategori" id="kategori"
                            placeholder="Nama Kategori">
                        <button type="submit" class="btn btn-outline-primary mt-3" name="tambah_kategori"
                            id="tambah_kategori">Tambah</button>
                    </form>
