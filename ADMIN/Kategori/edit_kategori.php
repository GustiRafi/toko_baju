...
if (isset($_POST["edit_kategori"])) {
    ...
    if ( edit_kategori($_POST) > 0 ) {
        echo "<script>
                ...
                document.location.href = '../Kategori/kategori.php';
            </script>";
    }else {
        echo "<script>
...
<head>
    ...
    <title>Edit Data Kategori | Fassen </title>
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" class="form-control" name="nama_kategori" id="nama_kategori"
                            placeholder="Nama Kategori" value="<?php echo $kategori['nama_kategori'] ?>" require>
                        <button class="btn btn-outline-primary text-center mt-2" type="submit" name="edit_kategori"
                            id="edit_kategori">Submit</button>
                    </form>
