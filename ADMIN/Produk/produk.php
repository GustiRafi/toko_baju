...
$produk = query("SELECT * FROM produk LEFT JOIN kategori USING (id_kategori) ORDER BY id_produk DESC");
if ( isset( $_POST ["cari"] ) ) {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-float">
                        <a href="tambah_produk.php"><button class="btn btn-outline-primary mt-3 mb-3">Tambah
                                Produk</button></a>
                        ...
                        <form class="d-flex" action="" method="post">
                            ...
                            <button class="btn btn-outline-primary" type="submit" name="cari" id="cari">Search</button>
                        </form>
                    </div>
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-striped table-responsive w-auto">
                            ...
                            <tr>
                                ...
                                <td width="50px"><?php echo $row["nama_produk"] ?></td>
                                <td><?php echo $row["nama_kategori"] ?></td>

                                <td>
                                    <img width="100px" height="100px" src="../../img/<?php echo $row['gambar']; ?>">
                                </td>

                                <td><?php echo $row["harga"] ?></td>
                                <td width="70px"><?php echo $row["deskripsi"] ?></td>
                                ...
                                <td>
                                    ...
                                    <?php } else if ($row["status_produk"] == 0) { ?>
                                    <p>tidak aktif</p>
                                    <?php } ?>
                                </td>
                                <td><?php echo $row["tanggal"] ?></td>
                                <td>
                                    <a href="edit_produk.php?id=<?php echo $row['id_produk'] ?>"><button
                                            class="btn btn-outline-success">Edit</button></a>

                                    <a href="hapus_produk.php?id=<?php echo $row['id_produk'] ?>" onclick="
                return confirm('Yakin Ingin menghapus data ini?')"><button
