...
$transaksi = query("SELECT * FROM transaksi LEFT JOIN produk USING (id_produk) ORDER BY id_transaksi DESC");
...
<head>
    ...
    <title>Data Transaksi | Fassen </title>
                    ...
                    <ul>
                        <li class="nav-item dropdown no-arrow  float-end">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="../user/logout.php" data-toggle="modal"
