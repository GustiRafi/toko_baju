...
$masukan = query("SELECT * FROM masukan ");
...
<head>
    ...
    <title>Masukan Untuk Web | Fassen </title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Masukan Untuk Website</h1>
                    </div>

                    <?php foreach($masukan as $row) {?>

                    <div class="border border-primary mb-3 rounded rounded-3 ">
                        <p class="mx-3 mt-2">Nama Pengirim : <?= $row["nama_pengirim"] ?></p>
                        <p class="mx-3">Isi :</p>
                        <p class="mx-3"><?= $row["isi"] ?></p>
                    </div>
